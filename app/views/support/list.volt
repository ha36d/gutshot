    ...
    <table class="table table-bordered table-striped" align="center">
        ...
        <tr>
            <td colspan="10" align="right">
                <div class="btn-group">
                    {{ link_to("support/list" ~ page.first, '<i class="icon-fast-backward"></i> First', "class": "btn") }}
                    {{ link_to("support/list?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous',
                    "class":
                    "btn ") }}
                    {{ link_to("support/list?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class":
                    "btn")
                    }}
                    {{ link_to("support/list?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class":
                    "btn")
                    }}
