<?php
namespace Gutshot\Auth;

use Phalcon\Mvc\User\Component;
use Gutshot\Models\Users;
use Gutshot\Models\RememberTokens;
use Gutshot\Models\SuccessLogins;
use Gutshot\Models\FailedLogins;

/**
 * Gutshot\Auth\Auth
 * Manages Authentication/Identity Management in Gutshot
 */
class Auth extends Component
{
    ...
    public function check($credentials)
    {
        ...
        $user = Users::findFirstByPlayer($credentials['player']);
        if ($user == false) {
        ...
        // Check the password
        if (!$this->security->checkHash($credentials['password'], $user->password) || $api -> Result != "Ok") {
     ...
     *
     * @param Gutshot\Models\Users $user
     */
