	...
	<tr>
		<td style="padding:40px 0  0 0;">
			<p style="color:#000;font-size: 16px;line-height:24px;font-family:'HelveticaNeue','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:normal;">
				...
				<p style="font-size: 13px;line-height:24px;font-family:'HelveticaNeue','Helvetica Neue',Helvetica,Arial,sans-serif;">You've successfully created a Gutshot account. To activate it, please click below to verify your email address.
				...
				<br>
					Moreover, your pin number for transfer and account change is {{ pin }}.
				<br>
				Gutshot!. Enjoy!
				<br>
			</p>
